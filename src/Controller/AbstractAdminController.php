...
abstract class AbstractAdminController extends AbstractController
{
    ...
    {
        $variables['commentReported'] = (new CommentRepository(Connection::getPDO()))->countReported();
        return parent::render($viewPath, $variables); // TODO: Change the autogenerated stub
    }
}
